...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Player p1 = new Player("Denise");//name: Ricardo - esta a iniciaizar a propriedade name de nome Ricardo
        Player p2 = new Player("Helder");
        ...
        rockpaperscissor.start(); //invocar o metodo play sobre o metodo que esta guardado nesta variável.
