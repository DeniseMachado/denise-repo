...
public class App {
    ...
    public static void main(String[] args) {
        ...
        JdbcUserService jdbcUserService = new JdbcUserService(connectionManager.getConnection());

        ///System.out.println(jdbcUserService.findByName("paulinho"));
        System.out.println(jdbcUserService.count());
